      ...
      <div className='container'>
        ...
        <form>
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="title" name='title' value={note.title} minLength={3} onChange={onChange} />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="tag" name='tag' value={note.tag} minLength={3} onChange={onChange} />
          </div>
